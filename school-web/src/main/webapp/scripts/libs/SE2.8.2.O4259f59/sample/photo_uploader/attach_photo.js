...
//					bSupportDragAndDropAPI = true; // XXX default
					bSupportDragAndDropAPI = false;
				}
			} else {
				bSupportDragAndDropAPI = false;
...
//    	sUploadURL= 'file_uploader_html5.php'; 	//upload URL
    	sUploadURL= '/users/upload/pictures'; 	// XXX 다중업로드
...
// 			sCallback : location.href.replace(/\/[^\/]*$/, '') + '/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
 			sUrl  : '/users/upload/picture', // XXX 단일업로드
 			sCallback : '/scripts/libs/SE2.8.2.O4259f59/sample/photo_uploader/callback.html',
